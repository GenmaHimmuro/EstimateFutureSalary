...
def get_rub_salaries_hh(vacancies_hh: list[dict[str | int]]) -> list[float | int]:
    salary_expectations = []
...
def get_rub_salaries_sj(vacancies_sj: list) -> list[float | int]:
    salary_expectations = []
...
def main():
    ...
    for lang in langs:
        ...
        salary_expectations_on_hh = get_rub_salaries_hh(all_vacancies_hh)
        salary_expectations_on_sj = get_rub_salaries_sj(all_vacancies_sj)
